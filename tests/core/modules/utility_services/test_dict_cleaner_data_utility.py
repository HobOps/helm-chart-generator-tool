...
def test_dict_cleaner_data_utility(fixture_config_settings_data, fixture_config_settings_clean_data):
    """
    ...
    assert config_settings_data_cleaned == fixture_config_settings_clean_data
