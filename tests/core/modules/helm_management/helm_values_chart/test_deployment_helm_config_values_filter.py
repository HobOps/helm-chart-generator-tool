...
def test_deployment_helm_config_values_filter(
    ...
    @param fixture_filtered_common_library_config_data: fixture_filtered_common_library_config_data
    @type fixture_filtered_common_library_config_data: dict
    ...
    helm_values_data_filtered = helm_deployment_env_vars_filter.process(conf=fixture_filtered_common_library_config_data)
