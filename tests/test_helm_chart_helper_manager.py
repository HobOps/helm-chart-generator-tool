...
def test_helm_chart_helper_manager_with_valid_params_v23():
    """
    test_helm_chart_helper_manager_with_valid_params_v23
    """

    app_version_factory = AppVersionCreator()
    app_manager = AppMainManagerV23()
    expected_app_version = "23"
